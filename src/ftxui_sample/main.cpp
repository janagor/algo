...
// configuration step. It creates a namespace called `algo`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", algo::cmake::project_name, algo::cmake::project_version) };
